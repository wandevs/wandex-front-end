...
import { addActivity, addOrderActivity, addTradeActivity } from '../../actions/activity';
      ...
      switch (data.type) {
        ...
        case 'orderChange':
          if (data.order.marketID === currentMarket.id) {
            dispatch(addOrderActivity(data.order));
            dispatch(orderUpdate(data.order));
          }
          break;
        case 'lockedBalanceChange':
          dispatch(addActivity("lockBalance:"+ data.symbol + ":" + data.balance));
          dispatch(
        ...
        case 'tradeChange':
          if (data.trade.marketID === currentMarket.id) {
            dispatch(addTradeActivity(data.trade));
